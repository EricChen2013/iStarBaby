...
public class FriendDetailAddActivity extends Activity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_friend_detail_add);
	...
	public void onClick(View v) {
		...
		case R.id.txt_add_friend:
			...
			intent.setClass(this, FriendAddSendActivity.class);

			startActivityForResult(intent,
					ConstantDef.REQUEST_CODE_FRIEND_ADDSEND);
