...
public class ChildHwActivity extends Activity implements OnClickListener,
		OnItemClickListener
{
	...
	private ArrayList<ChildGrowInfo> mDataTw;
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.activity_child_hw);
	...
	private void showView()
	{
		...
		mDataTw = new ArrayList<ChildGrowInfo>();
		...
		HttpGetUtil httpGetUtil = new HttpGetUtil(new RequestGetDoneCallback()
		{
			...
			public void requestWithGetDone(String result)
			{
				...
				ChildDataTwAdapter adapter = new ChildDataTwAdapter();
	...
	private void inItUi()
	{
		mListview = (ListView) findViewById(R.id.hw_list);
		mListview.setOnItemClickListener(this);
	}

	private class ChildDataTwAdapter extends BaseAdapter
	{
		@Override
		public int getCount()
		{
		...
		public View getView(int position, View convertView, ViewGroup parent)
		{
			...
			if (convertView == null)
			{
				...
				holder.eventDay = (TextView) convertView
						.findViewById(R.id.child_hw_eventday);
				holder.date = (TextView) convertView
						.findViewById(R.id.child_hw_date);

				holder.height = (TextView) convertView
						.findViewById(R.id.child_hw_height);
				holder.weight = (TextView) convertView
						.findViewById(R.id.child_hw_weight);
			...
			ChildGrowInfo childGrowInfo = mDataTw.get(position);
			...
			holder.height.setText(childGrowInfo.getHeight());
			holder.weight.setText(childGrowInfo.getWeight());
			...
			LayoutParams param2 = (LayoutParams) holder.height
					.getLayoutParams();
			param2.width = mDataWidth;
			holder.height.setLayoutParams(param2);

			LayoutParams param3 = (LayoutParams) holder.weight
					.getLayoutParams();
			param3.width = mDataWidth;
			holder.weight.setLayoutParams(param3);
	...
	private void backPrePage()
	{
		...
		{
			// 信息被修改过，需要返回更新数据
			this.setResult(ConstantDef.RESULT_CODE_CHILD_HWDATA, mIntent);
		}
		else
		{
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3)
	{
		...
		ChildGrowInfo childGrowInfo = mDataTw.get(arg2);
